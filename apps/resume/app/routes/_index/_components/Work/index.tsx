    ...
    content: [
      {
        ...
        list: [
          "인터랙션 라이브러리의 API 변경 시, 여러 서비스에서 반복적으로 발생하던 수동 마이그레이션 문제를 해결하기 위해 jscodeshift 기반 자동 마이그레이션 스크립트를 설계·구현했습니다.",
      ...
      },
      {
        ...
        list: [
          ...
          "불필요한 전역 상태 공유와 Shadow DOM 미적용으로 인해 발생하던 스타일 충돌 문제를 해결했습니다.",
          "태국어를 포함한 다국어 환경에서 텍스트가 깨지는 문제를 해결하고, 다국어 대응을 고려한 테스트 환경을 정비했습니다.",
        ],
      },
      {
