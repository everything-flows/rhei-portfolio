    ...
    <section>
      ...
      <article>
        ...
        <ul className="mt-2 list-disc ps-6">
          <li>
            디자인 시스템처럼, 반복되는 요소를 규칙화해서 사용자가 일관된 경험을
            할 수 있도록 돕습니다. 또한, 개발자가 디자인 시스템을 잘 사용할 수
            있도록 문서로 풀어내는 작업을 좋아합니다.
          </li>
          <li>
            애니메이션, 터치 이펙트 등 인터랙션에 사용되는 컴포넌트들을
            유지보수하고 있습니다. 인터랙션을 통해 화면의 완성도를 높이고,
            사용자의 불편함을 해소하는 일에 기여합니다.
          </li>
        </ul>
      </article>
